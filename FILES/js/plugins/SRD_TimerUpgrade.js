...
Sprite_Timer.prototype.createLabel = function() {
	...
	this.label.bitmap.fontFace = Okitsune.TU_Param(_.font);		//OKISTUNE
	this.label.bitmap.fontSize = _.labelSize;
	this.label.bitmap.fontItalic = _.italic;
	this.label.bitmap.textColor = Okitsune.TU_Param(_.color);	//OKISTUNE
...
Sprite_Timer.prototype.createBitmap = function() {
	...
	bitmap.fontFace = Okitsune.TU_Param(_.font);	//OKISTUNE
	...
	this.numBitmap.fontFace = Okitsune.TU_Param(_.font);	//OKISTUNE
	this.numBitmap.fontSize = fontSize;
	this.numBitmap.fontItalic = _.italic;
	this.numBitmap.textColor = Okitsune.TU_Param(_.color);	//OKISTUNE
...
Sprite_Timer.prototype.timerText = function() {
	let result = Okitsune.TU_Param(_.format);	//OKISTUNE
