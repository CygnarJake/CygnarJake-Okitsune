...
(function () {
    ...
    class Sprite_StaffRoll extends Sprite {
        ...
        createSection(section) {
            ...
            const currentLang = (typeof ConfigManager.getLanguage === "function")
		...
		textFontFace() {
			...
			let lang = (typeof ConfigManager.getLanguage === "function")
				? ConfigManager.getLanguage()
				: (ConfigManager.language || '日本語');
			// Prefer language font table, fall back to GameFont or system font
			return STAFFROLL_FONT_TABLE[lang]
				|| (typeof $gameSystem.mainFontFace === "function"
					? $gameSystem.mainFontFace() : 'GameFont, sans-serif');
		}
