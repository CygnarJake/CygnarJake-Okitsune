 ...
 * Performs a duplicate of CE 213 when the player enters the Item Scene.
 * @author CygnarJake
 *
 * @help
 * This plugin automatically performs a duplicate of CE 213 every time the
 * player opens the Item Scene. I believe I've fixed the lag during Kosen's battle,
...
(function () {
    ...
    Scene_Item.prototype.create = function () {
		...
		$gameSwitches.setValue(105, false);
