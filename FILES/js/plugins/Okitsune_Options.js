...
(function () {
    ...
    // Insert Voice Volume & SRD_TranslationEngine logic
    ...
    Window_Options.prototype.makeCommandList = function () {
        ...
        this._list = this._list.filter(cmd =>
                !["preferredRenderer", "aboutRenderer", "TKMFilterEnabledAll"].includes(cmd.symbol));
    ...
    // Make Voice Volume behave like other volume symbols
    ...
    // Status text (renderer info + voice volume)
    ...
    Window_AboutRenderer.prototype.refresh = function () {
        ...
        const lines = [
            ...
            null, "", "Canvas は低スペックの PC で安定する場合があります。",
    ...
    // Smaller label for "aboutRenderer" line
	...
	// Audio routing: listed SEs use Voice Volume
