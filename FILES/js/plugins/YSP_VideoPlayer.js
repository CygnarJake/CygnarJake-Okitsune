...
([function (t, e) {
            ...
            c = function (t, e, n) {
                ...
                l && (n = e);
                for (f in n)
                    (a = !p && b && void 0 !== b[f]) && f in h || (s = a ? b[f] : n[f], h[f] = l && "function" != typeof b[f] ? n[f] : y && a ? u(s, r) : x && b[f] == s ? function (t) {
            ...
            var o = n(100),
            u = r(o);
            (0, r(n(105)).default)(Spriteset_Base),
            ...
            c = function (t) {
                ...
                return e.baseTexture.autoPlay = !1,
                u[t] = e,
                e
            },
            f = function (t) {
            ...
            a = function (t) {
                SceneManager._scene._spriteset.addVideo(t),
                t.texture.baseTexture.source.play()
            },
            s = function (t) {
                var e = x(t);
                a(e)
            ...
            p = function (t) {
                SceneManager._scene._spriteset.removeVideo(t),
                t.texture.baseTexture.source.pause()
            },
            l = function (t) {
                var e = x(t);
                p(e),
            ...
            t.exports = function (t) {
                return function (e) {
                    for (var n, i = o(e), c = r(i), f = c.length, a = 0, s = []; f > a; )
                        u.call(i, n = c[a++]) && s.push(t ? [n, i[n]] : i[n]);
                    return s
                }
            }
        }, function (t, e, n) {
