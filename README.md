...
3. Improve `Outfit List.txt` to be more readable and better show the completion status of outfit assets.
4. Translating entries in the dictionary found within the terakoya.
...
5. Sometimes a text box can freeze, with no way to resume the game other than closing and relaunching. This has happened to me and at least one player, although I've been unable to replicate it even with their save file where it would always happen to them at Kosen's quest. This only happened while the JavaScript was updated to NW.js v0.103.1, which I've now reverted, so this might possibly be fixed although I still don't know what could cause it.
...
|	**Memories** - Standing pictures.<br>
|	**Kohaku-No-Mae** - Standing pictures.
