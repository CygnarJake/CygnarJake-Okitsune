...
b. Download the installer `_NTOT-Mod-Setup.exe` and place it inside the game’s main folder: **`古今東西おきつね物語`** or **`古今東西おきつね物語 Demo`**.
...
## Features
1. Multiple saves! Now, record up to 7 save slots!<br>
