...
$.isNewNWjs = !!(process.versions['nw'] || process.versions['node-webkit'] >= "0.13.0");
...
/* OKITSUNE: Replacing with own version in Okitsune_Outfits that will handle language images too.
