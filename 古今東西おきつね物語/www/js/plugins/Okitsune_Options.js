...
(() => {
	...
	Window_Options.prototype.isVolumeSymbol = function (symbol) {
		return symbol === 'voiceVolume' || (_Window_Options_isVolumeSymbol && _Window_Options_isVolumeSymbol.call(this, symbol)) || false;
	};
	...
	Window_Options.prototype.isCommandEnabled = function (index) {
		...
		if (!_Window_Options_isCommandEnabled) return true;
		const enabled = _Window_Options_isCommandEnabled.call(this, index);
		return enabled == null ? true : enabled;
	};

	const _Window_Options_update = Window_Options.prototype.update;
	Window_Options.prototype.update = function () {
		if (_Window_Options_update) _Window_Options_update.call(this);
	...
	Scene_Options.prototype.create = function () {
		...
		if (originalRenderer == null) originalRenderer = ConfigManager.preferredRenderer;
	};
