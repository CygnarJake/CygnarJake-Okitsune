...
//=============================================================================
/*:ja
 * @plugindesc (v1.1) マップ上のイベントにパーティクルエフェクトを追加します。
 * @author Moghunter
 *
 * @help
 * 翻訳:ムノクラ
 ...
 * プラグインコマンド
 * ===========================================================================
 * 下記のプラグインコマンドでパーティクルエフェクトを有効にします。
 *
 * particles_event_id : EVENT_ID : MODE : POWER : BLEND : X : Y : POSITION : FIAME
 *
 * EVENT_ID - マップイベントID
 * MODE - アニメーションの種類
 *          0:通常 / 1:ランダム
 * POWER - パーティクルの発生量?(元ヘルプに記述なし)
 * BLEND - 合成方法
 *           0:通常 / 1:加算
 * X - X方向の移動速度
 * Y - Y方向の移動速度
